...
program
  ...
  .action(
    /**
     * Handles the scan import command.
     *
     * @param {string} file - Path to the scan result file to import.
     * @param {Object} options - Command line options.
     * @param {string} [options.type] - Forced scan type (e.g. nessus, burp, openvas, nmap).
...
program
  ...
  .action(
    /**
     * Handles the report generation command.
     *
     * @param {Object} options - Report generation options.
     * @param {string} options.format - Format of the report (html, pdf, docx).
     * @param {string} options.output - Output file path.
     * @param {string} [options.template] - Report template name (standard, executive, technical).
     * @returns {Promise<void>}
     */
    async (options) => {
      try {
...
program
  ...
  .action(
    /**
     * Handles vulnerability findings management commands.
     *
     * @param {Object} options - Options for findings management.
     * @param {boolean} [options.list] - Whether to list all findings.
     * @param {boolean} [options.add] - Whether to add a new finding.
     * @param {string} [options.edit] - ID of the finding to edit.
     * @param {string} [options.delete] - ID of the finding to delete.
     * @param {string} [options.status] - New status to set for the finding.
     * @returns {Promise<void>}
     */
    async (options) => {
      try {
...
program
  ...
  .action(
    /**
     * Handles the interactive CLI mode command.
     *
     * @returns {Promise<void>}
     */
    async () => {
...
program
  ...
  .action(
    /**
     * Handles the summary dashboard display command.
     *
     * @returns {Promise<void>}
     */
    async () => {
...
program
  ...
  .action(
    /**
     * Handles the findings export command.
     *
     * @param {Object} options - Export configuration options.
     * @param {string} options.format - Export file format (csv or json).
     * @param {string} [options.output] - Target output file path.
     * @returns {Promise<void>}
     */
    async (options) => {
      try {
...
/**
 * Retrieves dashboard summary statistics for vulnerability findings.
 *
 * @async
 * @returns {Promise<{total: number, critical: number, high: number, medium: number, low: number, info: number, open: number, fixed: number, falsePositive: number}>} Object containing finding counts categorized by severity and status.
 */
...
/**
 * Exports findings data to a specified format and location.
 *
 * @async
 * @param {Object} options - Export settings.
 * @param {string} options.format - The target export format (e.g. 'csv' or 'json').
 * @param {string} [options.output] - Optional path where the exported file should be saved.
 * @returns {Promise<void>}
 */
